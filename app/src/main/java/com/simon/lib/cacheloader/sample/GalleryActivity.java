...
public class GalleryActivity extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            imageView = (ImageView) rootView.findViewById(R.id.section_icon);
            return rootView;
        }
        ...
        private void loadImage() {
            DownLoadManager.init(getContext(), new DownLoadManager.Configuration().setFlags
                    (DownLoadManager.FLAG_CACHE_AFTER_LOAD | DownLoadManager.FLAG_LOAD_FROM_CACHE));
            Callback callback = new Callback<Bitmap>() {
                @Override
